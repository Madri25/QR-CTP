 ...
 <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
      <li>
        <a class="app-menu__item" href="lista_correo.php">
            <i class="bi bi-envelope-plus-fill icon-margin"></i>
            <span class="app-menu__label">Correos</span>
            <a class="app-menu__item" href="lista_asistencia.php"><i class="bi bi-truck-front icon-margin"></i><span class="app-menu__label">Asistencia</span></a>
        </a>
      </li>
